...
; Definition of the getNextValue function which randomly generates a new
...
def getNextValue(previous_note):
    number = random()
    accum = 0
    i = 0
    while accum < number:
...
knewnote pycall1t ktrig, "getNextValue", klastnote ;get new note from chain
schedkwhen ktrig, 0, 10, 3, 0, 0.2, knewnote, ioct ;launch note on instrument 2
...
instr 3 ;A simple sine wave instrument
print p4
endin
